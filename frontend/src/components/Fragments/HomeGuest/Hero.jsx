...
const Hero = () => {
  ...
  // Kelas yang dipakai berulang agar konsisten & ringkas
  const sectionClass =
    "relative min-h-screen flex items-center px-4 sm:px-6 pt-24 pb-16 bg-cover bg-center bg-no-repeat";
  // Overlay: mobile lebih gelap merata agar teks terbaca penuh,
  // desktop kembali ke gradient kiri->transparan seperti semula
  const overlayClass =
    "absolute inset-0 bg-gradient-to-r from-black/90 to-black/40 md:to-transparent";
  const headingClass =
    "text-3xl sm:text-4xl md:text-6xl font-extrabold leading-tight";
  const primaryBtn =
    "px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base bg-emerald-500 text-white rounded-xl shadow hover:bg-emerald-600 transition";
  const outlineBtn =
    "px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base border border-emerald-400 text-emerald-300 rounded-xl hover:bg-emerald-400/20 transition";
  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide>
          <section
            ...
            style={{ backgroundImage: `url(${stunting})` }}
          >
            <div className={overlayClass}></div>

            <div className="relative w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center text-white">
              <div className="mb-8 md:mb-16" ref={refHeader}>
                <motion.div
                  key={activeIndex}
                ...
                >
                  <span className="inline-block mb-4 px-4 py-2 bg-emerald-500/30 rounded-full text-xs sm:text-sm">
                ...
                <p className="mt-6 max-w-xl text-sm sm:text-base text-gray-200 leading-relaxed">
                  {headerVisible && (
                    <Typewriter speed={20}>
                ...
                <div className="mt-8 flex flex-wrap gap-3 sm:gap-4">
                  <FadeSlide direction="left" delay={200}>
                    <button onClick={openAuth} className={primaryBtn}>
                      Mulai Sekarang
                    </button>
                  </FadeSlide>
                  <FadeSlide direction="right" delay={200}>
                    <button onClick={openAuth} className={outlineBtn}>
        ...
        <SwiperSlide>
          <section
            key={activeIndex}
            className={sectionClass}
            style={{ backgroundImage: `url(${stunting2})` }}
          >
            <div className={overlayClass}></div>
            ...
            <div className="relative w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center text-white">
              <div className="mb-8 md:mb-16">
                ...
                <p className="mt-6 max-w-xl text-sm sm:text-base text-gray-200 leading-relaxed text-left md:text-justify">
                  <Typewriter speed={20}>
                    Deteksi dini stunting melalui pemantauan tinggi dan berat
                    badan secara rutin membantu mengenali risiko sejak awal.
                    Dengan intervensi yang tepat dan edukasi berkelanjutan, kita
                    dapat memastikan anak tumbuh optimal dan memiliki masa depan
                    yang lebih sehat.
                  </Typewriter>
                </p>
        ...
        <SwiperSlide>
          <section
            key={activeIndex}
            className={sectionClass}
            style={{ backgroundImage: `url(${stunting3})` }}
          >
            <div className={overlayClass}></div>
            ...
            <div className="relative w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center text-white">
              <div className="mb-8 md:mb-16">
                ...
                <FadeUp delay={200}>
                  <h1 className={headingClass}>
                    Pemantauan
                    <span className="text-emerald-400"> Pertumbuhan</span>{" "}
                    Balita
                    <br />
                    Berbasis Website
                  </h1>
        ...
        <SwiperSlide>
          <section
            key={activeIndex}
            className={sectionClass}
            style={{ backgroundImage: `url(${stunting4})` }}
          >
            <div className={overlayClass}></div>
              ...
              <div className="mb-8 md:mb-16">
                ...
                <p className="mt-6 max-w-xl text-sm sm:text-base text-gray-200 leading-relaxed">
                  <Typewriter speed={20}>
                    ...
                    tua dapat mencatat, memantau, serta mengevaluasi pertumbuhan
                    anak secara berkala. Informasi yang tersaji secara
                    terintegrasi membantu pengambilan keputusan yang lebih cepat
                    dan tepat.
                  </Typewriter>
                </p>
      ...
      {/* Panah sembunyi di mobile (terlalu sempit), tampil mulai md */}
